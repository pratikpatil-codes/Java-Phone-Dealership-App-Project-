...
using Java OOP. 
2)Sales Tracking: Logged and displayed sales transactions for 
performance monitoring. 
3)User Interaction: Built a simple console interface using core Java 
methods.
4)Rule-Based Agent: Integrated a simple rule-based decision system to
automate basic actions and improve overall workflow efficiency.
